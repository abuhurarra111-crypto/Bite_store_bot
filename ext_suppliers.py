...
class ProdSellerAdapter(SupplierAdapterBase):
    KEY_ID = "prodseller"
    LABEL = "🛒 ProdSeller"
    # 🆕 v161.18: ProdSeller migrated to prodseller.com (new API docs).
    # Old http://51.77.244.194 now redirects/SSL-fails. New /v1/products/:id
    # returns a real `stock` field (null for custom-delivery products).
    DEFAULT_BASE_URL = "https://prodseller.com/v1"
