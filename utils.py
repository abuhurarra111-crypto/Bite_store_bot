...
# ════════════════════════════════════════════
# ✨ TELEGRAM MESSAGE EFFECTS (v170.46 — corrected)
# ════════════════════════════════════════════
# Telegram `message_effect_id` — sirf PRIVATE chats (1:1) me chalta hai.
# v170.45 me Edit Responses ka per-response picker tha — woh REMOVE kar diya
# (kaam nahi kar raha tha + IDs bhi galat thi). Yahan ab sirf sahi IDs ki
# table hai — aage GLOBAL "Message Effect" setting yahi se kaam karegi.
# Verified IDs (Bot API / official list):
#   🔥 Fire, ❤️ Heart, 👍 Like, 👎 Dislike, 🎉 Party, 💩 Poop
MESSAGE_EFFECTS = {
