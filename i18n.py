...
TRANSLATIONS = {
    # ══════════ COMMON ══════════
    "btn_back":            {"en": "🔙 Back",            "ur": "🔙 واپس",          "ru": "🔙 Back",         "hi": "🔙 Back"},
    ...
    "btn_yes":             {"en": "✅ Yes",             "ur": "✅ ہاں",           "ru": "✅ Yes",          "hi": "✅ Yes"},
    "btn_no":              {"en": "❌ No",              "ur": "❌ نہیں",          "ru": "❌ No",           "hi": "❌ No"},
    "loading":             {"en": "⏳ Loading...",      "ur": "⏳ لوڈ ہو رہا ہے...", "ru": "⏳ Loading...",             "hi": "⏳ Loading..."},
    "done":                {"en": "✅ Done",            "ur": "✅ ہو گیا",        "ru": "✅ Done",        "hi": "✅ Done"},
    "error":               {"en": "❌ Error occurred",  "ur": "❌ خرابی ہوئی",    "ru": "❌ Error occurred",      "hi": "❌ Error occurred"},
    "access_denied":       {"en": "❌ Access denied",   "ur": "❌ رسائی نہیں",     "ru": "❌ Access denied",       "hi": "❌ Access denied"},

    # ══════════ MAIN MENU BUTTONS ══════════
    "menu_shop":           {"en": "🛍️ Shop",           "ur": "🛍️ دکان",         "ru": "🛍️ Shop",        "hi": "🛍️ दुकान"},
    "menu_my_orders":      {"en": "📦 My Orders",      "ur": "📦 میرے آرڈرز",    "ru": "📦 My Orders",    "hi": "📦 मेरे ऑर्डर"},
    "menu_my_account":     {"en": "👤 My Account",     "ur": "👤 میرا اکاؤنٹ",    "ru": "👤 My Account",   "hi": "👤 मेरा खाता"},
    "menu_buy_points":     {"en": "💎 Buy Points",     "ur": "💎 پوائنٹس خریدیں", "ru": "💎 Buy Points",       "hi": "💎 पॉइंट्स खरीदें"},
    ...
    "lang_current":        {"en": "Current: ",          "ur": "موجودہ: ",          "ru": "Now: ",          "hi": "Now: "},
    ...
    "rev_no_reviews":      {"en": "📭 No reviews yet. Be the first!",
                            ...
                            "ru": "📭 No reviews yet. Be the first!",
                            "hi": "📭 No reviews yet. Be the first!"},
    "rev_write":           {"en": "✍️ Write Review",     "ur": "✍️ جائزہ لکھیں",   "ru": "✍️ Write Review",     "hi": "✍️ Write Review"},
    "rev_my":              {"en": "📝 My Reviews",       "ur": "📝 میرے جائزے",    "ru": "📝 My Reviews",       "hi": "📝 My Reviews"},
    "rev_pick_order":      {"en": "📦 Choose an order to review:",
                            "ur": "📦 جائزہ دینے کے لیے آرڈر منتخب کریں:",
                            "ru": "📦 Choose an order to review:",
                            "hi": "📦 Choose an order to review:"},
    "rev_no_eligible":     {"en": "❌ You need a delivered order to write a review.",
                            "ur": "❌ جائزہ لکھنے کے لیے آپ کے پاس ڈلیورڈ آرڈر ہونا چاہیے۔",
                            "ru": "❌ You need a delivered order to write a review.",
                            "hi": "❌ You need a delivered order to write a review."},
    "rev_pick_rating":     {"en": "⭐ Rate this product:\nTap stars below",
                            "ur": "⭐ اس پروڈکٹ کی درجہ بندی کریں:\nنیچے ستارے پر کلک کریں",
                            "ru": "⭐ Rate this product:\nTap stars below",
                            "hi": "⭐ Rate this product:\nTap stars below"},
    "rev_enter_text":      {"en": "✍️ Now write your review (or /skip):",
                            "ur": "✍️ اب اپنا جائزہ لکھیں (یا /skip):",
                            "ru": "✍️ Now write your review (or /skip):",
                            "hi": "✍️ Now write your review (or /skip):"},
    "rev_submitted":       {"en": "✅ Thank you! Your {stars} review has been submitted.",
                            "ur": "✅ شکریہ! آپ کا {stars} جائزہ جمع ہو گیا۔",
                            "ru": "✅ Thank you! Your {stars} review has been submitted.",
                            "hi": "✅ Thank you! Your {stars} review has been submitted."},
    "rev_already":         {"en": "ℹ️ You've already reviewed this product.",
                            "ur": "ℹ️ آپ پہلے ہی اس پروڈکٹ کا جائزہ دے چکے ہیں۔",
                            "ru": "ℹ️ You've already reviewed this product.",
                            "hi": "ℹ️ You've already reviewed this product."},
    ...
    "tier_your":           {"en": "🏆 Your Tier: ",      "ur": "🏆 آپ کی سطح: ",    "ru": "🏆 Your Tier: ",  "hi": "🏆 Your Tier: "},
    ...
    "tier_max":            {"en": "🎉 You're at the highest tier!",
                            ...
                            "ru": "🎉 You're at the highest tier!",
                            "hi": "🎉 You're at the highest tier!"},
    "tier_benefits":       {"en": "🎁 Your Benefits:",   "ur": "🎁 آپ کے فوائد:",   "ru": "🎁 Your Benefits:", "hi": "🎁 Your Benefits:"},
    "tier_upgraded":       {"en": "🎉 Congratulations! You've been upgraded to {tier} tier!",
                            "ur": "🎉 مبارک ہو! آپ کو {tier} سطح پر اپ گریڈ کر دیا گیا!",
                            "ru": "🎉 Congratulations! You've been upgraded to {tier} tier!",
                            "hi": "🎉 Congratulations! You've been upgraded to {tier} tier!"},
    ...
    "an_no_data":          {"en": "📭 No data yet",      "ur": "📭 ابھی کوئی ڈیٹا نہیں", "ru": "📭 No data yet", "hi": "📭 No data yet"},
