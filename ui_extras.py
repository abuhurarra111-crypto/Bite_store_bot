...
_GUIDES = {
    ...
    "deposit": (
        ...
        '\n'
        '*Step 3:* Pick a payment method — ⭐ Telegram Stars, Bybit, Binance USDT, '
        'Bybit USDT, EasyPaisa or JazzCash (whatever is enabled).\n'
        '\n'
        '*⭐ Telegram Stars (fastest):*\n'
        '  • Choose *Telegram Stars* → bot shows Stars amount (1$ = 120 Stars).\n'
        '  • Tap *Pay X Stars* → Telegram opens its secure payment window.\n'
        '  • Pay → points added instantly — no ID or screenshot needed.\n'
        '\n'
    ...
    "pay_bybit": (
        "💳 *Bybit — Step-by-Step*\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "*A) Bybit to Bybit (Internal Transfer — recommended):*\n"
        "*Step 1:* At checkout pick *💳 Bybit*.\n"
        "*Step 2:* Tap *Continue*, enter your Bybit UID (digits only).\n"
        "*Step 3:* Bot gives a *unique amount* + a *UID to send to*.\n"
        "*Step 4:* Open Bybit App → *Assets* → *Withdraw*.\n"
        "*Step 5:* Withdrawal Method → *Crypto Withdrawal*.\n"
        "*Step 6:* Choose *USDT* → Transfer Type → *Internal Transfer* 🔁.\n"
        "*Step 7:* At the top select *UID* → paste the bot's UID.\n"
        "*Step 8:* Paste the exact amount from the bot → tap *Withdraw* ✅.\n"
        "*Step 9:* Back to bot → *Copy Amount* / *Copy UID*, tap "
        "*🔍 Check Payment* → verified → delivered.\n\n"
        "⚠️ *Do NOT send via Bybit Pay* — only *Internal Transfer* is auto-detected.\n\n"
        "*B) Bybit USDT (TRC20 / BEP20 — external network):*\n"
        "*Step 1:* Pick *💎 Bybit USDT* and choose network (TRC20 or BEP20).\n"
        "*Step 2:* Bot shows the deposit *address* + exact amount.\n"
        "*Step 3:* Send USDT to that address (same network).\n"
